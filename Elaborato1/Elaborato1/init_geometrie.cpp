...
void INIT_CANNONE(Curva* curva) {
    ...
    vec3 centro = vec3(0.0, 0.0, 0.0);
    vec4 color_top = vec4(0.0, 0.0, 0.0, 1.0);
    vec4 color_bot = vec4(0.5, 0.5, 0.5, 1.0);
    CostruisciHermite(t, curva, centro, color_top, color_bot);
...
void INIT_BERSAGLIO(Curva* curva) {
    ...
    int i;
    Dati dati[1000];
    FILE* file = fopen("bersaglio.txt", "r");
    ...
    t[curva->CP.size()] = 1.0;
    vec3 centro = vec3(-0.3, 0.1, 0.0);
    vec4 color_top = vec4(1.0, 0.6, 0.2, 1.0);
    vec4 color_bot = vec4(1.0, 1.0, 0.0, 1.0);
    CostruisciHermite(t, curva, centro, color_top, color_bot);
...
void INIT_SCUDO(Curva* curva) {
    ...
    t[curva->CP.size()] = 1.0;
    vec3 centro = vec3(0.0, 0.0, 0.0);
    vec4 color_top = vec4(0.0, 0.6, 0.8, 1.0);
    vec4 color_bot = vec4(0.0, 1.0, 1.0, 1.0);
    CostruisciHermite(t, curva, centro, color_top, color_bot);
