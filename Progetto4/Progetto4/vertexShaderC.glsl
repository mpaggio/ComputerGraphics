...
uniform mat4 Model;			// La matrice di modellazione da applicare ai vertici: composizione di trasformazioni elementari. 
uniform mat4 Projection;	// La matrice di Proiezione, che dalle coordinate del mondo, alle coordinate NDC (-1,1)x(-1, 1)
