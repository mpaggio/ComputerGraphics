...
void main()
{
    ...
    vec2 center = vec2(0.0);   //// Definisce il centro della finestra in coordinate NDC. 
    ...
    FragColor = vec4(s * 0.1 , s * 0.2, s * 0.7, 1.0);  //Se il frammento appartiene ad una fascia concentrica di ampiezza 0.4 viene colorato di bianco, altrimenti rimane nero.
